            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        {{-- Memanggil Component Add Product --}}
                        @can('manage-product')
                    ...
                    @if (session('success'))
                        <div
                            class="mb-6 px-4 py-3 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-700 dark:text-green-300 rounded-lg text-sm">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    <th
                                        class="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider w-12">
                                        #</th>
                                    <th
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                {{-- Tombol View tetap manual karena tidak dibuat Component-nya --}}
                                                ...
                                                {{-- Memanggil Component Edit Button --}}
                                                @can('update', $product)
                                                    <x-edit-button :url="route('product.edit', $product)" />
                                                @endcan

                                                {{-- Memanggil Component Delete Button --}}
                                                @can('delete', $product)
